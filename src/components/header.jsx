        ...
        <div>
            ...
            <div
                className="main-tool-bar fixed top-0 left-0 w-full 
                   ...
                   transition-all duration-300 z-50 p-10"
            >
                <div className="flex items-center justify-between p-8">
                     <div className="flex items-center justify-between">
                       <Image src={logo} alt="logo" className="h-18 w-18" />
                     </div>
                     <div className="  font-satoshi mt-2 ml-20">
                        <ul className="p-4 font-satoshi flex items-center justify-center gap-10 text-xl">
                            <li className="text-black  font-semibold text-xl cursor-pointer hover:text-xl hover:text-gray-800 hover:duration-600 hover:transition-all">Insights</li>
                            <li className="text-black  font-semibold text-xl cursor-pointer hover:text-xl hover:text-gray-800 hover:duration-600 hover:transition-all">About us</li>
                            <li className="text-black  font-semibold text-xl cursor-pointer hover:text-xl hover:text-gray-800 hover:duration-600 hover:transition-all">Contact us</li>
                        </ul>
                     </div> 
                </div>

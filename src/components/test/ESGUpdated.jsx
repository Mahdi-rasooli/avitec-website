...
const esgData = [
  { key: "e", letter: "E", title: "Environment", bgImage: "/img29.jpg", description: "Pioneering sustainable solutions to protect our planet for future generations. We are committed to minimizing our footprint and maximizing our positive impact." },
...
function ESGsection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const entryTl = gsap.timeline({
        ...
        onComplete: () => {
          gsap.to(mainRef.current, { backgroundColor: "black", duration: 1, ease: "power2.inOut" });
          gsap.to(".letter", { color: "white", duration: 1, ease: "power2.inOut" });
  ...
  return (
    <div ref={pinContainerRef} className="h-screen relative">
      <main ref={mainRef} className="h-screen w-screen overflow-hidden font-satoshi bg-white text-black">
        ...
        <div className="relative z-10 flex h-full w-full">
          {esgData.map((item) => (
            <button
              ...
              <h2 data-section={item.key} aria-hidden="true" className="letter text-[17vw] md:text-[15vw] font-black select-none absolute top-[10%] left-[50%] -translate-x-1/2 -translate-y-[10%] text-black opacity-0">{item.letter}</h2>
